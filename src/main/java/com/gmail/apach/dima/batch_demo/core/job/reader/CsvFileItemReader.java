package com.gmail.apach.dima.batch_demo.core.job.reader;
...
public abstract class CsvFileItemReader<T> extends FlatFileItemReader<T> {
    ...
    protected LineTokenizer lineTokenizer() {
        ...
        lineTokenizer.setDelimiter(Constant.COMMA);
    ...
    protected abstract Resource getResource() throws ObjectStorageException;
}
