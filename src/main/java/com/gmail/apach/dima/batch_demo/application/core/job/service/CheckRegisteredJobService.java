...
import com.gmail.apach.dima.batch_demo.port.input.job.CheckRegisteredJobInputPort;
...
public class CheckRegisteredJobService implements CheckRegisteredJobInputPort {

    private final RegisteredJobExistsOutputPort registeredJobExistsOutputPort;
    private final MessageUtil messageUtil;

    @Override
    public void checkRegistration(String jobName) {
