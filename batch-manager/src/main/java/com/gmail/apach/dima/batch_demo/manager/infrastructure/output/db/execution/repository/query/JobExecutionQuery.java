package com.gmail.apach.dima.batch_demo.manager.infrastructure.output.db.execution.repository.query;

import lombok.AccessLevel;
import lombok.NoArgsConstructor;

@NoArgsConstructor(access = AccessLevel.PRIVATE)
public final class JobExecutionQuery {

    public static final String SELECT_EXECUTED_JOB =
        "   SELECT " +
        "       bjep.parameter_value          as job_execution_marker,              " +
