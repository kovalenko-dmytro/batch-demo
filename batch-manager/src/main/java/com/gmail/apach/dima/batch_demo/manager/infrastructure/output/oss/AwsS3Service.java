package com.gmail.apach.dima.batch_demo.manager.infrastructure.output.oss;
...
import com.gmail.apach.dima.batch_demo.manager.infrastructure.output.oss.config.AwsS3Properties;
import com.gmail.apach.dima.batch_demo.manager.infrastructure.output.oss.mapper.AwsS3Mapper;
...
public class AwsS3Service implements ObjectStorageServiceOutputPort {
    ...
    public StoredResource save(@NotNull MultipartFile file) {
        ...
        try {
            ...
            log.error(messageUtil.getMessage(Error.FILE_UNABLE_UPLOAD, objectKey, e.getMessage()));
