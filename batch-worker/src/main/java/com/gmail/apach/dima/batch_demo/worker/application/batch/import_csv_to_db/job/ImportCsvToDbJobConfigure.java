package com.gmail.apach.dima.batch_demo.worker.application.batch.import_csv_to_db.job;

import com.gmail.apach.dima.batch_demo.worker.application.batch.import_csv_to_db.job.listener.CleanupOnFailureJobListener;
...
public class ImportCsvToDbJobConfigure {
    ...
    @Bean(name = JobName.IMPORT_CSV_TO_DB)
    public Job job() {
        return new JobBuilder(JobName.IMPORT_CSV_TO_DB, configure.getJobRepository())
