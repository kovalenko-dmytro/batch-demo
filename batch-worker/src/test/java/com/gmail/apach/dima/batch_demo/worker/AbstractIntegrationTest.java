...
import com.gmail.apach.dima.batch_demo.worker.infrastructure.output.oss.AwsS3Service;
...
@SpringBootTest(classes = BatchWorkerApplication.class)
@SpringBatchTest
...
public abstract class AbstractIntegrationTest {
    ...
    protected StoredResource uploadFile(String filePath) {
        return awsS3Service.save(new File(filePath));
    }
}
